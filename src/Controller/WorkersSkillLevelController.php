...
/**
 * @Route("/workers/skill/level")
 */
class WorkersSkillLevelController extends AbstractController
{
    /**
     * @Route("/", name="workers_skill_level_index", methods={"GET"})
     */
    public function index(WorkersSkillLevelRepository $workersSkillLevelRepository): Response
    {
        return $this->render('workers_skill_level/index.html.twig', [
            'workers_skill_levels' => $workersSkillLevelRepository->findAll(),
        ]);
    }
